...
## Project Structure
    ...
    ├── tst_daniels_codegen_34816  # Django project configurations
...
1. Clone this repo and `cd tst_daniels_codegen_34816`
...
2. Clone this repo and `cd tst_daniels_codegen_34816`
